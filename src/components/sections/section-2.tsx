    ...
    <>
      <div className="grid grid-cols-1 h-[300vh] lg:h-screen lg:grid-cols-2 grid-rows-6 lg:grid-rows-2">
        ...
        <div className="col-span-1 row-span-1">
          <ImageBlock src={"/tech/bg-desktop.webp"} />
        </div>
      ...
      <div className="grid grid-cols-1 gap-4 h-[250vh] lg:h-screen lg:grid-cols-4 lg:grid-rows-2 mt-4">
        <div
          className={`${font_accent.className} col-span-1 lg:col-span-2 lg:row-span-1
            text-6xl flex items-center justify-center lg:justify-start`}
        >
          Почему мы?
        </div>
        ...
        <div className="col-span-1 row-span-1 relative">
          ...
          >
            Минималистичные линии, масштабные проекты и реставрация — берём
        ...
        <div className="bg-gray-900 col-span-1 lg:col-span-2 lg:row-span-1 relative">
          ...
          <motion.span
            ...
            className="image-text"
          >
            Опытные мастера и авторские эскизы — каждая работа продумана до
            линии.
          </motion.span>
        </div>
